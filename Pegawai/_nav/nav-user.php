...
<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-clipboard-account"></i><span class="hide-menu">Data Pribadi</span></a>
    <ul aria-expanded="false" class="collapse  first-level">
        ...
        <li class="sidebar-item"><a href="?view=daftar-gaji&id=9973852hupa&name=pegaaplication&daftarAbsen" class="sidebar-link"><i class="mdi mdi-credit-card"></i><span class="hide-menu"> Data Gaji </span></a></li>
...
<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Pengajuan </span></a>
    <ul aria-expanded="false" class="collapse  first-level">
        <li class="sidebar-item"><a href="?view=pengajuan-cuti&id=9973851hupa&name=pegaaplication&daftarCuti" class="sidebar-link"><i class="mdi mdi-calendar"></i><span class="hide-menu"> Cuti </span></a></li>
        <li class="sidebar-item"><a href="?view=pengajuan-lembur&id=9973852hupa&name=pegaaplication&daftarLembur" class="sidebar-link"><i class="mdi mdi-clock"></i><span class="hide-menu"> Lembur </span></a></li>
        <li class="sidebar-item"><a href="?view=pengajuan-pinjaman&id=9973853hupa&name=pegaaplication&daftarLembur" class="sidebar-link"><i class="mdi mdi-credit-card-plus"></i><span class="hide-menu"> Pinjaman Karyawan </span></a></li>
