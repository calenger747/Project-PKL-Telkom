                                    ...
                                    <?php
                                        ...
                                        if ($j_data == 0) {
                                            ...
                                            while ($a_bag = mysqli_fetch_array($q_bagian)) { ?>
                                                ...
                                                <a href=
                                                "config_config_cs/del-bank-con.php?id=<?php echo $a_bag['kode_bank']; ?>" title="Hapus Data" onClick="return confirm('Anda Yakin Ingin Menghapus Data <?php echo $a_bag[1];?> ?')"><span class='fa fa-trash'></span></a>
                                                </tr>
